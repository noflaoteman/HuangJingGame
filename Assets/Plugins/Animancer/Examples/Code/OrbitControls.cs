...
namespace Animancer.Examples
{
    ...
    public sealed class OrbitControls : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                Vector2 movement = ExampleInput.MousePositionDelta;
            ...
            float zoom = ExampleInput.MouseScrollDelta.y * _Sensitivity.z;
            Vector2 mousePosition = ExampleInput.MousePosition;
            if (zoom != 0 &&
