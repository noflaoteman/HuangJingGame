...
namespace Animancer.Examples.AnimatorControllers.GameKit
{
    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        public void UpdateSpeedControl()
        {
            ...
            float deltaSpeed = movement != default ? Acceleration : Deceleration;
        ...
        private Vector3 GetRootMotion()
        {
            ...
            direction.Normalize();
            float magnitude = Vector3.Dot(direction, motion);
        ...
        private void CheckGround(ref Vector3 movement)
        {
            ...
            Ray ray = new Ray(transform.position + GroundedRayDistance * 0.5f * Vector3.up, -Vector3.up);
