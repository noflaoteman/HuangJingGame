...
namespace Animancer.Examples.Locomotion
{
    ...
    public sealed class SpiderBotController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            AnimancerState state = _SpiderBot.Animancer.States.GetOrCreate(_SpiderBot.Move);
        ...
        private void Update()
        {
            ...
            if (_MoveState.IsActive)
            {
                ...
                float targetEulerY = Camera.main.transform.eulerAngles.y;
        ...
        private Vector3 GetMovementDirection()
        {
            ...
            float movementThisFrame = _MovementSpeed * _SprintMultiplier * Time.fixedDeltaTime;
