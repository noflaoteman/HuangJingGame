...
namespace Animancer.Editor
{
    ...
    internal static class UnityVersionChecker
    {
        ...
        {
            System.Reflection.Assembly assembly = typeof(AnimancerEditorUtilities).Assembly;
            ...
            System.Reflection.AssemblyDescriptionAttribute attribute = (System.Reflection.AssemblyDescriptionAttribute)attributes[0];
            if (attribute.Description.EndsWith($"Unity {ExpectedAssemblyTarget}+."))
                return;

            string actualAssemblyTarget = attribute.Description.Substring(attribute.Description.Length - 14, 13);
            if (!actualAssemblyTarget.StartsWith("Unity "))
                actualAssemblyTarget = "[Unknown]";

            string message = $"{assembly.GetName().Name}.dll was compiled for {actualAssemblyTarget}" +
            ...
            int choice = UnityEditor.EditorUtility.DisplayDialogComplex($"{assembly.GetName().Name}.dll Version Mismatch",
                message,
