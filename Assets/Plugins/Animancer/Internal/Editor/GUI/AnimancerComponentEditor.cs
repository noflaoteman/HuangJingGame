...
namespace Animancer.Editor
{
    ...
    public class AnimancerComponentEditor : BaseAnimancerComponentEditor
    {
        ...
        {
            Animator animator = property.objectReferenceValue as Animator;
            ...
            if (animator == null)
            {
                ...
                if (AnimancerGUI.TryUseClickEventInLastRect())
                {
                    ...
                    {
                        IAnimancerComponent target = (IAnimancerComponent)targetProperty.serializedObject.targetObject;
            ...
            else
            {
                ...
                AnimatorUpdateMode? initialUpdateMode = Targets[0].InitialUpdateMode;
        ...
        private bool AreAllResettingTargetsAboveTheirAnimator()
        {
            ...
            {
                IAnimancerComponent target = Targets[i];
