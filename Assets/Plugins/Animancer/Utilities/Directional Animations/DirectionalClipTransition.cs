        ...
        public new class Drawer : TransitionDrawer
        {
                ...
                GUIContent label)
            {
                ...
                if (path.EndsWith($".{ClipFieldName}"))
                {
                    ...
                    {
                        Rect removeArea = AnimancerGUI.StealFromRight(
                            ref area, AnimancerGUI.LineHeight, AnimancerGUI.StandardSpacing);

                        using (ObjectPool.Disposable.AcquireContent(out GUIContent removeLabel, "X",
                    ...
                    {
                        Rect dropdownArea = AnimancerGUI.StealFromRight(
            ...
            private void PickAnimation(SerializedProperty property, object source)
            {
                ...
                using (ObjectPool.Disposable.AcquireSet<AnimationClip>(out HashSet<AnimationClip> clips))
                {
