...
#pragma warning restore IDE0079 // Remove unnecessary suppression.
        ...
        internal static string GetChangeError(Type stateType, Type machineType, string changeType = "State")
        {
            ...
            System.Diagnostics.StackFrame[] stackTrace = new System.Diagnostics.StackTrace(1, false).GetFrames();
            for (int i = 0; i < stackTrace.Length; i++)
            {
                Type type = stackTrace[i].GetMethod().DeclaringType;
            ...
            if (baseStateType != null)
            {
                ...
                System.Reflection.MethodBase caller = stackTrace[1].GetMethod();
                if (caller.DeclaringType == typeof(StateExtensions))
                {
                    string propertyName = stackTrace[0].GetMethod().Name;
            ...
            else
            {
                ...
                else
                {
                    ...
                    foreach (Type type in activeChangeTypes)
                    {
                        text.Append("     - ")
