...
namespace Animancer.FSM
{
        ...
        where TState : class, IState
    {
        ...
        public override void InitializeAfterDeserialize()
        {
            ...
            else if (Dictionary.TryGetValue(_CurrentKey, out TState state))
            {
        ...
        {
            if (Dictionary.TryGetValue(key, out TState state) &&
        ...
        {
            Dictionary.TryGetValue(key, out TState state);
        ...
        {
            TryGetValue(key, out TState state);
            return state;
        }
        ...
        public override void DoGUI(ref Rect area)
        {
            ...
            TKey key = StateMachineUtilities.DoGenericField(area, "Current Key", _CurrentKey);
