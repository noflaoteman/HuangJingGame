...
namespace Animancer
{
    ...
    public abstract partial class CustomFade : Key, IUpdatable
    {
        ...
        protected void Apply(AnimancerState state)
        {
            ...
            {
                AnimancerNode other = parent.GetChild(i);
        ...
        protected void Apply(AnimancerNode node)
        {
            ...
            AnimancerPlayable animancer = node.Root;
        ...
        void IUpdatable.Update()
        {
            ...
            if (_Time < 1)// Fade.
            {
                float weight = CalculateWeight(_Time);
                ...
                {
                    NodeWeight node = FadeOutNodes[i];
        ...
        {
            float weight = node.TargetWeight;
