        ...
        where TState : ControllerState
    {
        ...
        public override float MaximumDuration
        {
            get
            {
                ...
                AnimationClip[] clips = _Controller.animationClips;
        ...
        ControllerState.ITransition, ICopyable<ControllerTransition>
    {
        ...
        public class Drawer : Editor.TransitionDrawer
        {
                ...
                GUIContent label)
            {
                ...
                {
                    SerializedProperty controllerProperty = rootProperty.FindPropertyRelative(MainPropertyName);
            ...
            protected void DoParameterGUI(Rect area, AnimatorController controller, SerializedProperty property)
            {
                ...
                using (ObjectPool.Disposable.AcquireContent(out GUIContent label, parameterName))
                {
