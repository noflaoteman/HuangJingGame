...
namespace Animancer
{
        ...
        ISerializationCallbackReceiver, ICopyable<ClipTransitionSequence>
    {
        ...
        void ISerializationCallbackReceiver.OnAfterDeserialize()
        {
            ...
            ClipTransition previous = _Others[0];
        ...
        public override float MaximumDuration
        {
            get
            {
                float value = base.MaximumDuration;
                for (int i = 0; i < _Others.Length; i++)
        ...
        public override float AverageAngularSpeed
        {
            get
            {
                float speed = base.AverageAngularSpeed;
                if (_Others.Length == 0)
                    return speed;

                float duration = base.MaximumDuration;
                speed *= duration;

                for (int i = 0; i < _Others.Length; i++)
                {
                    ClipTransition other = _Others[i];
                    float otherSpeed = other.AverageAngularSpeed;
                    float otherDuration = other.MaximumDuration;
        ...
        public override Vector3 AverageVelocity
        {
            get
            {
                Vector3 velocity = base.AverageVelocity;
                ...
                {
                    ClipTransition other = _Others[i];
                    Vector3 otherVelocity = other.AverageVelocity;
                    float otherDuration = other.MaximumDuration;
        ...
        {
            float start = transition.NormalizedStartTime;
