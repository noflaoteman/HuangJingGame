        ...
        ManualMixerState.ITransition2D, ICopyable<MixerTransition2D>
    {
        ...
        public class Drawer : MixerTransitionDrawer
        {
            ...
            protected override void AddThresholdFunctionsToMenu(GenericMenu menu)
            {
                ...
                {
                    if (AnimancerUtilities.TryGetAverageVelocity(state, out Vector3 velocity))
            ...
            {
                int oldSpeedCount = CurrentSpeeds.arraySize;
                ...
                SerializedProperty type = property.FindPropertyRelative(nameof(_Type));
            ...
            {
                Editor.MenuFunctionState functionState = CurrentAnimations == null || CurrentThresholds == null
                ...
                AddPropertyModifierFunction(menu, label, functionState, property =>
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        SerializedProperty threshold = CurrentThresholds.GetArrayElementAtIndex(i);
                        Vector2 value = calculateThreshold(state, threshold.vector2Value);
                ...
                Func<Object, float, float> calculateThreshold)
            {
                AddPropertyModifierFunction(menu, label, (property) =>
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        Vector2 value = threshold.vector2Value;
                        float newValue = calculateThreshold(state, value[axis]);
